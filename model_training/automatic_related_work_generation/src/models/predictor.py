...
class Translator(object):
    ...
    def translate(self,
        ...
        self.model.eval()
        gold_path = os.path.join(self.args.result_path, f'{step}.gold')
        can_path = os.path.join(self.args.result_path, f'{step}.candidate')
        ...
        raw_src_path = os.path.join(self.args.result_path, f'{step}.raw_src')
    ...
    def _fast_translate_batch(self,
        ...
        for step in range(max_length):
            ...
            topk_beam_index = topk_ids.div(vocab_size, rounding_mode='trunc')  # 改过
